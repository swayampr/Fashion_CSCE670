...
# Comparison Network for outfit compatibility prediction and diagnosis.
class CompatModel(nn.Module):
    ...
    # Visual semantice loss which map both visual embedding and semantic embedding into a common space.
